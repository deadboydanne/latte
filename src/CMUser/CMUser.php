...
class CMUser extends CObject implements IHasSQL {
  ...
  public static function SQL($key=null) {
    $queries = array(
      ...
      'create table user'  => "CREATE TABLE IF NOT EXISTS User (id INTEGER PRIMARY KEY, username VARCHAR(30) UNIQUE, name VARCHAR(30), email VARCHAR(30), password VARCHAR(64), created DATETIME);",
      'insert into user'   => 'INSERT INTO User (username,name,email,password) VALUES (?,?,?,?);',
