<?php
/**
 * Main class for Latte, holds everything.
 *
 * @package LatteCore
 */
class CLatte implements ISingleton {
  ...
  /**
	 ...
	 * @return CLatte The instance of this class.
	 */
	public static function Instance() {
		if(self::$instance == null) {
			self::$instance = new CLatte();
		}
  ...
  public function ThemeEngineRender() {
    ...
    $themePath         = LATTE_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = LATTE_INSTALL_PATH . '/' . $this->config['theme']['parent'];
      $parentUrl        = $this->request->base_url . $this->config['theme']['parent'];
    }
    
    // Add stylesheet name to the $lt->data array
    $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
    
    // Make the theme urls available as part of $lt
    ...
    $lt = &$this;
    // First the default Latte themes/functions.php
  ...
  /**
   * Draw HTML for a menu defined in $lt->config['menus'].
   *
