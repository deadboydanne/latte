  ...
  public function GetHTML() {
    ...
    if($this['type'] == 'submit') {
      ...
      foreach($this['values'] as $val) {
        ...
        $ret .= "<p><input id='{$id}'{$type}{$class}{$name}{$value}{$autofocus}{$readonly}{$checked} /><label style='display:inline;' for='$id'>&nbsp;$label</label>{$messages}</p>\n"; 
      }
